...
exports.createJsonFiles = function () {
    ...
    var convertLocales = new Promise(function (resolve, reject) {
        fs.readdir(source_path, function (err, files) {
            ...
            // Find any app.*.po files and use them to determine which locales we have
            // available
            files.forEach(function (file, idx) {
                ...
                // Find all the other locale files for this locale and join them
                // together into a single locale translation
                files.forEach(function (localeFilename) {
                    ...
                    var fileContent = fs.readFileSync(
                        source_path + localeFilename
                    );
                    data = Buffer.concat([data, fileContent]);
                });

                i18next_conv
                    .gettextToI18next(locale, data)
