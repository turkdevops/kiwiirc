...
describe('MessageParser.js', () => {
  ...
  it('should return valid user blocks', () => {
    ...
    let users = {
      testnick1 :
          {nick : 'TestNick1', username : 'testnick1', colour : '#a1fc5d'},
      testnick2 :
          {nick : 'TestNick2', username : 'testnick2', colour : '#7363fe'},
    ...
    tests.forEach((c) => {
      ...
      expect(userBlocks[0].meta.colour)
          .toEqual(users[compare.toLowerCase()].colour);
    });
  });
