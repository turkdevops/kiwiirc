...
export function formatText(formatId, formatParams) {
  ...
  // Most texts only have a 'text' variable so allow passing of a string for
  // this variable as shorthand.
...
// Convert a given duration in seconds to human readable
// weeks,days,hours,minutes,seconds only showing the duration parts that are
// used eg 3666 --> 1 hour, 1 minute, 6 seconds
