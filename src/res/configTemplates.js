...
export const configTemplates = {
  ...
  default : {
    ...
    // If active, all connections will be routed via this BNC server. Network
    // settings will be read and updated to the BNC as they are changed.
    bnc : {
      active : false,
      server : '',
      port : 6667,
    ...
    buffers : {
      ...
      // If timestamp_full_format is falsy, the browsers locale date format will
      // be used
